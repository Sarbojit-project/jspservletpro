...
<html>
    ...
    <body>
        ...
        <%
            ...
            if (m != null) {
        %>
        <div class="alert <%=m.getCssClalss()%>"  role="alert">
            <%= m.getContent()%>
        </div>
        <%
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header primary-background text-white text-center">
                        <h5 class="modal-title" id="exampleModalLabel">Tech Blogg</h5>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="add-post-form" action="AddPostServlet" method="post">
                            ...
                            <div class="form-group">
                                <textarea name="pContent" class="form-control" style="height:200px;" placeholder="Enteryour content"></textarea>
                            </div>
                            <div class="form-group">
                                <textarea name="pCode" class="form-control" style="height:200px;" placeholder="Enter your progrom (if any)"></textarea>
                            </div>
                ...
                $("#add-post-form").on("submit", function (event) {
                    ...
                    $.ajax({
                        ...
                        success: function (data, textStatus, jqXHR) {
                            ...
                            //after setting dopost value we will get the message
                            if (data.trim() == 'done') {
        ...
        <!-- loading post ajax we are printing the load posts value in right side of the column whatever will be written -->
        <script>
